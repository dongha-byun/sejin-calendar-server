...
@NoArgsConstructor
@Getter
public class CustomCompanyUpdateDto {
    private String name;
    ...
    @Builder
    public CustomCompanyUpdateDto(String name, CompanyType type, String ceoName, String registrationNumber,
                                  String address,
